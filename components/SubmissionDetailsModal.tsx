...
// Add a universal social platform button component
const SocialButton = ({
  href,
  icon: Icon,
  label,
...
export default function SubmissionDetailsModal({
  ...
  // renderProofContent function copied and modified from MemberSubmissionTable
      ...
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto bg-background border-border">
        ...
        {submission && task && (
          <div className="mt-4 space-y-6">
            ...
            {/* Review section - only visible to reviewers */}
