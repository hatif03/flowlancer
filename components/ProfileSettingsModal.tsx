...
function ProfileSettingsModalInner({
  ...
  // Monitor wallet address changes and clear non-Telegram social account data
  useEffect(() => {
    if (userAddress) {
  ...
  // Handle Telegram account autofill
  useEffect(() => {
  ...
  const handleSave = async () => {
    try {
      ...
      // Call a contract using a signature
  ...
  // Handling Telegram verification clicks
  ...
  useEffect(() => {
    ...
    // If there is modal parameter or shouldOpenModal, perform verification and open the pop-up window
