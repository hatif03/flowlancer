          ...
          if (!connected) {
            return (
              <Button
                ...
                className="bg-blue-500/20 text-blue-100 hover:bg-blue-500/30 backdrop-blur-sm"
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    size={isMobile ? "sm" : "default"}
                    className="bg-gradient-to-r from-blue-500/10 to-blue-700/10 hover:from-blue-500/20 hover:to-blue-700/20 border border-blue-500/30 hover:border-blue-500/50 text-blue-300"
                  >
                    {profile?.avatar ? (
                      <Image
                        src={profile.avatar}
                        alt="Profile"
                        className="w-5 h-5 rounded-full mr-2 ring-2 ring-blue-500/30"
                        width={20}
                        height={20}
                      />
                    ) : (
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-[200px] bg-black/90 border border-blue-500/30 backdrop-blur-xl"
                >
                  ...
                  <DropdownMenuItem
                    ...
                    className="hover:bg-blue-500/20 text-gray-300 hover:text-white transition-colors"
                  >
