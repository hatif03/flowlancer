...
// Create the parameter interface of Board
...
export interface TaskConfig {
  ...
  contractNetwork?: 'Mantle' | 'Mantle Sepolia' | 'Linea' | 'Linea Sepolia' | 'Ethereum' | 'Sepolia' | 'Flow EVM' | 'Flow EVM Testnet';
  XPostContent?: string;
...
// Create parameter interface for Task
...
// Submit Proof’s parameter interface
...
// Review submitted parameter interface
...
// Add auditor's parameter interface
...
// Parameter interface for pledged tokens
