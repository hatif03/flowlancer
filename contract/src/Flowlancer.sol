    ...
    SubmissionManager
{
    ...
    event FlowlancerClosed(uint256 indexed boardId);
    ...
    function updateFlowlancer(
        ...
        emit FlowlancerUpdated(_boardId, _name, _description, _rewardToken, _config);
    }
    ...
    function closeBoard(uint256 _boardId) public {
        ...
        board.closed = true;
        emit FlowlancerClosed(_boardId);
    }
