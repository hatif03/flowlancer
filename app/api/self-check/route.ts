...
// Verify social account operations
async function verifySocialAction(taskConfig: any, proofData: any) {
  try {
    ...
    // Check if there are any Twitter related tasks
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Get the configuration of the corresponding chain
    ...
    // Get the contract address of the corresponding chain
    ...
    // Verify whether the task allows self-testing
